...
- Pair with banana or apple slices
- Add a spoon to porridge for extra protein
- Blend into dressings with soy sauce, lime, and ginger

Ask in‑store for our current favourites.
